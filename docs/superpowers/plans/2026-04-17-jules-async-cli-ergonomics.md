...
- **Modify:** `/Users/jeffbai/repos/jules-review/jules.py` — all new API + CLI logic
- **Create:** `/Users/jeffbai/repos/jules-review/tests/__init__.py` — empty
- **Create:** `/Users/jeffbai/repos/jules-review/tests/conftest.py` — shared fixtures (fake session dicts, JULES env vars)
- **Create:** `/Users/jeffbai/repos/jules-review/tests/test_jules.py` — all tests
- **Create:** `/Users/jeffbai/repos/jules-review/pytest.ini` — pytest config
- **Modify:** `/Users/jeffbai/repos/jules-review/requirements.txt` — add `pytest==8.3.4`
...
Use the Edit tool to append the following to the END of `/Users/jeffbai/repos/jules-review/README.md` (do not disturb existing content):
